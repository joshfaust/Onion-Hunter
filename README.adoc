...
image::docs/tor_icon.jpg[float="left",100]
...
image::docs/hunting.PNG[align=center, title-align=center, title=Reddit Search]
image::docs/purge.PNG[align=center, title-align=center, title=Reddit Search]
